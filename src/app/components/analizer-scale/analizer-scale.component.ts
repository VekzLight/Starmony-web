...
@Component({
  selector: 'app-analizer-scale',
  templateUrl: './analizer-scale.component.html',
  styleUrls: ['./analizer-scale.component.scss']
})
export class AnalizerScaleComponent implements OnInit, AfterViewInit{
  ...
  constructor(
    ...
    private analyzerService:AnalyzerService) {
      this.elementsContainerService.scaleDetail = this.elementsContainerService.scaleAnalized;
    }
